  ...
  if (id) {
    ...
    const sql = `
      UPDATE barangay_clearance SET
        ...
        document_type = ?, purpose = ?, business = ?, business_address = ?
      WHERE id = ?
    `;
    ...
    const values = [
      first_name, middle_initial, last_name, gender, nationality,
      civil_status, contact_number, birth_date, years_resident, 
      document_type, purpose, business, business_address, id
    ];
    ...
    const sql = `
      INSERT INTO barangay_clearance (
        first_name, middle_initial, last_name, gender, nationality,
        civil_status, contact_number, birth_date, years_resident, 
        document_type, purpose, business, business_address, reference_id, request_date, status
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 'Draft')
    `;
