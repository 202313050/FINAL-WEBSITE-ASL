document.addEventListener('DOMContentLoaded', function() {
  ...
  forms.forEach(form => {
      ...
      // Get the Next button in the form
      ...
      if (nextButton) {
          ...
          nextButton.addEventListener('click', function(event) {
              ...
              if (isValid) {
                  // If the next button is an anchor tag, navigate to its href
                  if (nextButton.tagName === 'A') {
                      window.location.href = nextButton.getAttribute('href');
                  } 
                  // If it's a button inside an anchor tag
                  else if (nextButton.parentNode.tagName === 'A') {
                      window.location.href = nextButton.parentNode.getAttribute('href');
                  }
                  // If it's a regular button, submit the form
                  else {
                      form.submit();
                  }
              } else {
